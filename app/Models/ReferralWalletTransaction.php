...
class ReferralWalletTransaction extends Model
{
    ...
    public function getSourceBadgeAttribute()
    {
        return match ($this->source) {
            ...
            'referral_verification' => ['label' => 'Profile Verified', 'class' => 'bg-cyan-500/20 text-cyan-400 border-cyan-500/30', 'icon' => 'fa-check-double'],
            'referral_interview' => ['label' => 'Interview Scheduled', 'class' => 'bg-amber-500/20 text-amber-400 border-amber-500/30', 'icon' => 'fa-handshake'],
            'referral_selection' => ['label' => 'Selected for Placement', 'class' => 'bg-indigo-500/20 text-indigo-400 border-indigo-500/30', 'icon' => 'fa-user-check'],
            'referral_placement' => ['label' => 'Joined Successfully', 'class' => 'bg-emerald-500/20 text-emerald-400 border-emerald-500/30', 'icon' => 'fa-award'],
            'milestone_bonus' => ['label' => 'Milestone Bonus', 'class' => 'bg-yellow-500/20 text-yellow-400 border-yellow-500/30', 'icon' => 'fa-trophy'],
