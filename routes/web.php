...
Route::get('/api/jobs/search-suggestions', [\App\Http\Controllers\HomeController::class, 'jobSuggestions'])->name('api.jobs.suggestions');
...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/leads/bulk-delete', [\App\Http\Controllers\Admin\ContactLeadController::class, 'bulkDestroy'])->name('leads.bulk-delete');
