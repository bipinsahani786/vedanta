...
@section('actions')
    <a href="{{ route('admin.subjects.create') }}" class="px-4 py-2 bg-accent-blue text-white rounded-xl text-sm font-semibold hover:bg-accent-blue-hover transition-all shadow-lg flex items-center gap-2">
...
<div class="bg-card-bg rounded-t-2xl border-x border-t border-card-border p-4 flex flex-col sm:flex-row justify-between items-center gap-4">
    ...
    <form action="{{ route('admin.subjects.index') }}" method="GET" class="w-full sm:w-auto flex items-center relative">
        ...
        @if(request('search'))
            <a href="{{ route('admin.subjects.index') }}" class="absolute right-3 text-text-dark/40 hover:text-red-400 transition-colors">
            ...
            <tr>
                ...
                <td>
                    <div class="flex items-center justify-end gap-2">
                        <a href="{{ route('admin.subjects.edit', $subject) }}" class="w-8 h-8 rounded-lg bg-accent-blue/10 text-accent-blue flex items-center justify-center hover:bg-accent-blue hover:text-white transition-colors tooltip" title="Edit">
