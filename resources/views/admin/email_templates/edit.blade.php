...
@section('subtitle', 'Update your reusable email template')
        ...
        <div class="w-full md:w-3/4 p-8 border-b md:border-b-0 md:border-r border-gray-100">
            <form action="{{ route('admin.email-templates.update', $emailTemplate->id) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $emailTemplate->name) }}" required class="w-full rounded-xl border-gray-300 shadow-sm text-sm py-3 px-4 focus:ring-blue-500 focus:border-blue-500">
                </div>

                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">Email Subject <span class="text-red-500">*</span></label>
                    <input type="text" name="subject" value="{{ old('subject', $emailTemplate->subject) }}" required class="w-full rounded-xl border-gray-300 shadow-sm text-sm py-3 px-4 focus:ring-blue-500 focus:border-blue-500">
                </div>

                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">Email Body <span class="text-red-500">*</span></label>
                    <textarea name="body" id="body-editor">{{ old('body', $emailTemplate->body) }}</textarea>
                </div>
