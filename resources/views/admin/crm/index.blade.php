...
@section('actions')
    <a href="{{ route('admin.crm.create') }}" class="px-5 py-2.5 bg-accent-blue text-white rounded-xl text-sm font-bold shadow hover:bg-accent-blue-hover transition-colors flex items-center gap-2">
