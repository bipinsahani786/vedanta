...
<div class="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-secondary-bg relative overflow-hidden">
    ...
    <div class="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-accent-yellow/10 rounded-full blur-[100px] pointer-events-none"></div>

    <div class="max-w-md w-full text-center relative z-10">
        <div class="w-24 h-24 rounded-3xl bg-accent-yellow/10 text-accent-yellow flex items-center justify-center text-5xl mx-auto mb-8 shadow-lg -rotate-3">
            <i class="fas fa-search"></i>
        </div>
        
        <h1 class="text-7xl font-black text-text-main mb-2 tracking-tighter">404</h1>
        <h2 class="text-2xl font-bold text-text-main mb-4">Page Not Found</h2>
