...
<style>
    /* Mobile optimization for dynamic service content */
    @media (max-width: 768px) {
        .service-content-wrapper .bg-white.p-8,
        .service-content-wrapper .bg-slate-50.p-8 {
            padding: 1.25rem !important; /* p-5 equivalent */
        }
        .service-content-wrapper .grid > .bg-white {
...
<div class="py-12 md:py-20 px-4 md:px-6 lg:px-[5%] bg-slate-50 relative">
    <div class="max-w-6xl mx-auto bg-white p-5 md:p-10 lg:p-14 rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.05)] border border-slate-100 reveal">
        <div class="text-slate-700 service-content-wrapper">
            {!! $service->content !!}
        </div>
