...
@section('content')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 reveal reveal-delay-1">
            ...
            {{-- Availability Status --}}
            <div class="bg-card-bg rounded-2xl border border-card-border p-6 shadow-sm hover:shadow-xl hover:border-accent-yellow/30 transition-all flex flex-col group">
                <div class="flex justify-between items-start mb-4">
                    ...
                    <span class="inline-flex items-center gap-1.5 px-3 py-1 bg-green-500/10 border border-green-500/30 text-green-400 text-xs font-bold uppercase tracking-wider rounded-lg">
                        <span class="w-2 h-2 rounded-full bg-green-400 animate-pulse"></span> Active
                    </span>
                </div>
                <h3 class="text-lg font-bold text-text-main mb-2">Availability Status</h3>
                <p class="text-sm text-text-dark/50 mb-6 flex-1">Let schools know you are actively looking for opportunities and available for interviews.</p>
                <button class="mt-auto px-4 py-2.5 bg-secondary-bg text-text-main text-sm font-semibold rounded-xl hover:bg-card-border/50 transition-colors text-center border border-card-border flex items-center justify-center gap-2">
